...
declare module "vue-router" {
    interface RouteMeta {
        ...
        svgIcon?: string
        // 设置该路由的图标，直接使用 Element Plus的icon
        elIcon?: string
        ...
        breadcrumb?: boolean
        // 默认false,如果设置为true,则会固定在tags-view中
        affix?: boolean
        /**
         * 当一个路由下面的children 声明的路由大于1时，自动会变成嵌套的模式
         * 只有一个时，会将那个子路由当作根路由显示在侧边栏
         * 若想不管路由下面的children 声明的个数都显示你的根路由
